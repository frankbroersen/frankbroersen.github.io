...
/**
 * Updated version, to make the chance 50/50
 */
(function($){
...
/**
 * Updated version, to make the chance 75/25
 */
(function($){
    ...
    function findNeighbors(x, y) {
        ...
        // we want the chance of having x be 75%, and y 25%
        // this is hardcoded, since we have only 3 possibilities
        if(count.x === 1 && count.y === 1) {    // y == 1, so we want to have 3 x
            neighbors.push(option_x);
            neighbors.push(option_x);
        }
        if(count.x === 2 && count.y === 1) {    // y == 1, so we want to have 3 x
            neighbors.push(option_x);
        }
        if(count.x === 1 && count.y === 2) {    // y == 2, so we want to have 6 x
            neighbors.push(option_x);
            neighbors.push(option_x);
            neighbors.push(option_x);
            neighbors.push(option_x);
...
/**
 * Updated version, to make the chance 25/75
 */
(function($){
    ...
    function findNeighbors(x, y) {
        ...
        if(count.x === 1 && count.y === 2) {    // y == 1, so we want to have 3 x
            neighbors.push(option_y);
        }
        if(count.x === 2 && count.y === 1) {    // y == 2, so we want to have 6 x
            neighbors.push(option_y);
            neighbors.push(option_y);
            neighbors.push(option_y);
            neighbors.push(option_y);
