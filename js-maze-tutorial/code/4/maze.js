...
(function($){
    ...
    function findNeighbors(x, y) {
        ...
        if(count.y === 1 && count.x === 1) {    // y == 1, so we want to have 9 x
            for(var i = 0; i < 9; i++) {
                neighbors.push(option_x);
            }
        }
        if(count.y === 1 && count.x === 2) {    // y == 1, so we want to have 9 x
            for(var i = 0; i < 9; i++) {
                neighbors.push(option_x);
            }
        }
        if(count.y === 2 && count.x === 1) {    // y == 2, so we want to have 18 x
            for(var i = 0; i < 18; i++) {
                neighbors.push(option_x);
            }
        }
...
(function($){
    ...
    function findNeighbors(x, y) {
        ...
        if(count.x === 1 && count.y === 1) {    // x == 1, so we want to have 9 y
            for(var i = 0; i < 9; i++) {
                neighbors.push(option_y);
            }
        }
        if(count.x === 1 && count.y === 2) {    // x == 1, so we want to have 9 y
            for(var i = 0; i < 9; i++) {
                neighbors.push(option_y);
            }
        }
        if(count.x === 2 && count.y === 1) {    // x == 2, so we want to have 18 y
            for(var i = 0; i < 18; i++) {
                neighbors.push(option_y);
            }
        }
